...
def mostrar_menu():
    print("\n --- Menu de gestion Boris APP ---")
    print("1. Registrar Mascota")
    print("2. Registrar Cliente")
    print("3. Registrar Producto")
    print("4. Registrar Venta")
    print("5. Registrar informacion acerca de Mascotas")
    print("6. Registrar informacion acerca de Clientes")
    print("7. Registrar informacion acerca de Productos")
    ...
    while True:
        ...
        if opcion == "1":
            ...
            if cliente:
                ...
                print("Cliente registrada con exito")
            ...
            print("Saliendo del sistema ¡Gracias por confiar en Boris APP")
